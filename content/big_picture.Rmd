...
The [Medicare Coverage by Hospital]( https://hello-world-415.shinyapps.io/Medicare_Coverage_by_Hospital/) interactive board shows the medicare coverage pattern based on each kind of disease that is categorized as DRG by the Medicare program. Using this board, you can visualize medicare coverage for each DRG you are interested in and consider how much you are benefiting from Medicare for a certain total payment.
