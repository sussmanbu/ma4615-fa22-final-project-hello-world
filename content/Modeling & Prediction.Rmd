...
HCC_Test <- read_csv(here::here("dataset","HCC.csv"),col_types=cols_only(BENE_AVG_RISK_SCRE=col_number(),ACUTE_HOSP_READMSN_PCT=col_number(),state=col_character()))
HCC_Test <- na.omit(HCC_Test)
problems(HCC_Test)
```
